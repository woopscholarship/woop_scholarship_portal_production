<script lang="ts">
	...
	const activeSidebarStyle =
		'bg-indigo-50 group flex items-center px-3 py-2 text-sm font-medium border-l-4"';
...
<a
	{href}
	class={$page.url.pathname.includes(href) ? activeSidebarStyle : defaultSidebarStyle}
	sveltekit:prefetch
>
	{text}
</a>
